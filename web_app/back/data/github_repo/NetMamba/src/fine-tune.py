...
def main(args):
    ...
    best_acc = 0
    best_epoch = 0
    # Setup tqdm outside loop
    pbar = tqdm(total=args.epochs, desc="Training Progress", dynamic_ncols=True)
    ...
    torch.save(model, "output_dir/NetMamba/finetuned_NetMamba_{}.pth".format(args.data_path.split("/")[-1]))
