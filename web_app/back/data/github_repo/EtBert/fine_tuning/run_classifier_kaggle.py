...
def evaluate(args, dataset, print_confusion_matrix=False, output_json_path=None):
    ...
    for i, (src_batch, tgt_batch, seg_batch, _) in enumerate(batch_loader(batch_size, src, tgt, seg)):
        ...
        all_targets.extend(gold.cpu().tolist())
    ...
    if print_confusion_matrix:
        ...
        with open(args.output_path_confusion_matrix, 'w') as f:
    ...
    macro_precision = sum(precision_list) / args.labels_num
    macro_recall = sum(recall_list) / args.labels_num
    macro_f1 = sum(f1_list) / args.labels_num
...
def main():
    ...
    parser.add_argument("--output_path_confusion_matrix", default='confusion_matri',
                        help="confusion matrix.")
    parser.add_argument("--output_result", default='result.json',
                        help="confusion matrix.")
    ...
    if args.test_only==True:
        ...
        for epoch in tqdm.tqdm(range(1, args.epochs_num + 1)):
            ...
            accuracy,confusion = evaluate(args, read_dataset(args, args.test_path,output_json_path=args.output_result))
    ...
    if args.test_path is not None:
        ...
        evaluate(args, read_dataset(args, args.test_path), True,args.output_result)
